...
<div class="card uper" style="margin-bottom:50px;">
  ...
  You are editing an existing Order status</button></a>
  ...
  <div class="card-body">
        ...
        @endif
           ...
           {!! Form::open(array('method'=>'PUT',
                                'action' => array(
                                                'OrderstatusController@update', $orderstatus->id))) !!}
        ...
        {!!  Form::submit('Modify this Order Status',['class'=>'btn btn-secondary']) !!}
